 ...
 * @apiName            listChannelBans
 *
 * @api                {GET} /v1/channel/{id}/bans List channel bans
 * @apiDescription     Retrieve list of bans for specific channel
 *
 * @apiVersion         1.0.0
...
$router->get('channel/{id}/bans', [
    'uses'  => 'Controller@listChannelBans',
    'middleware' => [
      'auth:api',
    ],
]);
